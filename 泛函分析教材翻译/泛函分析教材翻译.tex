\documentclass[lang=cn,a4paper,11pt,openany,scheme=chinese,twoside,leqno]{elegantbook}
...
\newcommand{\allbf}[1]{\bfseries\boldmath{#1}}
\newcommand{\bluebf}[1]{\textcolor{structurecolor}{\allbf{#1}}}
