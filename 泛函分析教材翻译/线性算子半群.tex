...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.9\textwidth]{images/bo_d6ik6nn7aajc739ct1l0_132_122_1026_1232_463_0.jpg}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.73\textwidth]{images/bo_d6ik6nn7aajc739ct1l0_143_164_1407_1153_511_0.jpg}
...
\noindent 6．尚需证明线性算子 $A$ 确为该半群的生成元.为此，记 $B$ 为半群 $\left\{  {{S}_{t};t \geq  0}\right\}$ 的生成元.据前述，已知 $B$ 是定义在 $\operatorname{Dom}\left( B\right)$ (在 $X$ 中稠密)上的线性闭算子.需证 $B = A$ .
...
{W}_{n}\left( t\right)  = \begin{cases} \frac{{\left( n/T\right) }^{n}}{\left( {n - 1}\right) !}{t}^{n - 1}{e}^{-\left( {n/T}\right) t}, & t \geq  0, \\  0, &t < 0. \end{cases}
\end{equation}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{images/bo_d6ik6nn7aajc739ct1l0_147_261_663_916_703_0.jpg}
...
$\operatorname{Dom}\left( A\right)  = \left\{  {u \in  {L}^{1}\left( \mathbb{R}\right) ;u\;\text{绝对连续，且 }\;{u}_{x} \in  {L}^{1}\left( \mathbb{R}\right) }\right\}$ .
