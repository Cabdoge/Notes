\documentclass[lang=cn,a4paper,11pt,openany,scheme=chinese,chinesefont=nofont,twoside]{elegantbook}
...
\setCJKmainfont   {LXGWNeoZhiSong} [ AutoFakeBold=2 , ItalicFont = {LXGWNeoZhiSong} ]
% 中文无衬线字体：微软雅黑，粗体为对应的微软雅黑粗体
\setCJKsansfont   { LXGWNeoXiHei } [ AutoFakeBold=2]
% 中文等宽字体：仿宋
\setCJKmonofont   { LXGWWenKai-Regular}[BoldFont= {LXGWZhenKaiGB} ]
% 设置中文字族
\setCJKfamilyfont { zhsong  } { LXGWNeoZhiSong}
\setCJKfamilyfont { zhhei   } { LXGWNeoXiHei}[ AutoFakeBold=1.25]
\setCJKfamilyfont { zhfs    } { LXGWWenKai-Regular}[BoldFont= {LXGWZhenKaiGB} ]
\setCJKfamilyfont { zhkai   } { TsangerJinKai05 W03}[BoldFont= {TsangerJinKai05 W05} ]
% 字体命令，可用于文档中自由设置字体
...
%调整页边距
\usepackage{geometry}
\geometry{top=2cm, bottom=2cm, outer=2cm, inner=2.5cm}
